      ...
      <div className="absolute inset-0 bg-black opacity-10"></div>
        <div className="flex flex-col items-start justify-center h-full pl-10">
          ...
          <div className="absolute bottom-14 left-10 flex gap-8 z-0">
            <Button style={{backgroundColor: '#f3c851'}} className="text-base font-light text-black px-10 py-5 rounded-lg">DONATE NOW </Button>
            <Button className="text-base font-light bg-white text-black px-10 py-5 rounded-lg">LEARN MORE </Button>
          </div>
        </div>
